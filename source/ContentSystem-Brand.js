/**
 * ContentSystem-Brand — the application's wordmark / signature.
 *
...
// Path: source/ → up 1 to retold-content-system/.
const tmpPackage = require('../package.json');

if (!tmpPackage.retold || !tmpPackage.retold.brand)
{
	throw new Error('retold-content-system: package.json is missing retold.brand — '
